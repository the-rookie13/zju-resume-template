...
{计算机辅助蛋白质设计} \hfill 2025.08 -- 2026.01 \titlebreak
具体经历：本人于2025年3月进入浙江大学药学院侯廷军老师实验室进行AI For Science相关学习，并于2025年8月开始在师兄指导下进行计算机辅助蛋白质设计的相关科研。科研具体内容为在现有从头蛋白质设计方法RSO基础上进行进一步探索，将原本的在logits表示上进行优化的方法改为在embedding表示上进行优化。项目锻炼了我的论文阅读能力、代码阅读与编写能力，使我对科研有了一定的基础认识，并积攒了一定的经验。
